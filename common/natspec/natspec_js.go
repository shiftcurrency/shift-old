 ...
 * @param {String} type
 * @returns {Number} length of dynamic type, 0 or multiplication of SHF_PADDING (32)
 */
var dynamicBytesLength = function (type) {
    if (isArrayType(type) || type === 'bytes')
        return c.SHF_PADDING * 2;
    return 0;
};
...
var formatInputInt = function (value) {
    var padding = c.SHF_PADDING * 2;
    BigNumber.config(c.SHF_BIGNUMBER_ROUNDING_MODE);
...
var formatInputString = function (value) {
    return utils.fromAscii(value, c.SHF_PADDING).substr(2);
};
...
module.exports = {
    ...
    SHF_POLLING_TIMEOUT: 1000,
    SHF_DEFAULTBLOCK: 'latest'
};
...
var unitMap = {
    ...
    'kshift':   '1000000000000000000000',
    'grand':    '1000000000000000000000',
    'einstein': '1000000000000000000000',
    'mshift':   '1000000000000000000000000',
    'gshift':   '1000000000000000000000000000',
    'tshift':   '1000000000000000000000000000000'
};
 ...
 * @param {String} unit the unit to convert to, default shift
 * @returns {BigNumber} value of the unit (in Wei)
 * @throws error if the unit is not correct:w
 */
var getValueOfUnit = function (unit) {
    unit = unit ? unit.toLowerCase() : 'shift';
...
/**
 * Takes a number of wei and converts it to any other shift unit.
 *
 * @method fromWei
 ...
 * @param {String} unit the unit to convert from, default shift
 * @return {String|Object} When given a BigNumber object it returns one as well, otherwise a number
*/
