...
mine(PyObject *self, PyObject *args) {
    ...
    do {
        ...
        // TODO: disagrees with the spec https://github.com/shiftcurrency/wiki/wiki/Ethash#mining
...
PyMODINIT_FUNC PyInit_pyethash(void) {
    ...
    // Following Spec: https://github.com/shiftcurrency/wiki/wiki/Ethash#definitions
