...
// ReleaseOracle is an Shift contract to store the current and previous
// versions of the go-ethereum implementation. Its goal is to allow Gshift to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gshift releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gshift release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Shift user, either
