...
var (
	abiFlag = flag.String("abi", "", "Path to the Shift contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Shift contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Go struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Shift contract Solidity source to build and bind")
