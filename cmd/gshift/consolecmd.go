...
// localConsole starts a new gshift node, attaching a JavaScript console to it at the
// same time.
...
// remoteConsole will connect to a remote gshift instance, attaching a JavaScript
// console to it.
func remoteConsole(ctx *cli.Context) error {
	// Attach to a remotely running gshift instance and start the JavaScript console
	client, err := utils.NewRemoteRPCClient(ctx)
	if err != nil {
		utils.Fatalf("Unable to attach to remote gshift: %v", err)
	}
	config := console.Config{
...
// ephemeralConsole starts a new gshift node, attaches an ephemeral JavaScript
