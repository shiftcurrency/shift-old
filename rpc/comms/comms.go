...
func handle(id int, conn net.Conn, api shared.ShiftApi, c codec.Codec) {
	codec := c.New(conn)
...
// ${protocol}:${path}
// e.g. ipc:/tmp/gshift.ipc
//      rpc:localhost:53900
func ClientFromEndpoint(endpoint string, c codec.Codec) (ShiftClient, error) {
