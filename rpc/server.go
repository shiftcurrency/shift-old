...
const (
	...
	DefaultIPCApis  = "admin,eth,shf,debug,miner,net,shh,txpool,personal,web3"
	DefaultHTTPApis = "eth,shf,net,web3"
)
...
func (s *Server) readRequest(codec ServerCodec) ([]*serverRequest, bool, RPCError) {
	...
	for i, r := range reqs {
		...
		if r.isPubSub { // shf_subscribe, r.method contains the subscription method name
