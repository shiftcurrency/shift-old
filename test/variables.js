...
var normalizer = 100000000; // Use this to convert SHIFT amount to normal value
...
// Random SHIFT Amount
var SHIFT = Math.floor(Math.random() * (100000 * 100000000)) + 1; // Remove 1 x 0 for reduced fees (delegate + Tx)
