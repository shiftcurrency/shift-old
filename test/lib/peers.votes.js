...
function makeVote (delegates, passphrase, action, done) {
    ...
    var transaction = node.shift.vote.createVote(passphrase, delegates.map(function (delegate) {
...
function sendSHIFT (amount, recipientId, done) {
...
describe("POST /peer/transactions", function () {
    ...
    before(function (done) {
        async.series([
            ...
            function (seriesCb) {
                sendSHIFT(100000000000, account.address, seriesCb);
            },
            function (seriesCb) {
