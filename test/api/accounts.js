...
describe('GET /api/accounts/getBalance?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getBalance('thisIsNOTAShiftAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error').to.eql('Object didn\'t pass validation for format address: thisIsNOTAShiftAddress');
			done();
		});
	});
...
describe('GET /api/accounts/getPublicKey?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getPublicKey('thisIsNOTAShiftAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error').to.contain('Object didn\'t pass validation for format address: thisIsNOTAShiftAddress');
			done();
		});
	});
...
describe('GET /accounts?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getAccounts('thisIsNOTAValidShiftAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error');
			node.expect(res.body.error).to.contain('Object didn\'t pass validation for format address: thisIsNOTAValidShiftAddress');
			done();
		});
	});
